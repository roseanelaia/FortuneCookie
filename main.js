...
let randomPhrases = document.querySelector("#randomPhrases")
let gerenateRandomPhrases


btnTry.addEventListener('click', handleTryClick)   //clicar no cookie
...
function handleTryClick() {
    ...
    gerenateRandomPhrases = Math.floor(Math.random()*(phrases.length));

    randomPhrases.innerText = phrases[gerenateRandomPhrases]
}
